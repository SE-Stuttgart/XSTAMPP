...
import acast.model.controlaction.interfaces.IUCAHazLink;
...
public class ControlActionController {
	 ...
	 * @author Fabian Toth
	 */
	public ATableModel getControlAction(UUID controlActionId) {
		for (ATableModel controlAction : this.controlActions) {
	...
	public List<IControlAction> getAllControlActionsU() {
		...
		for (ControlAction controlAction : this.controlActions) {
			result.add((IControlAction) controlAction);
		}
		return result;
	}
