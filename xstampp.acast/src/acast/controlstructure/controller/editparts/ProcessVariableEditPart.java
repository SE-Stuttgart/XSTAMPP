...
import acast.controlstructure.figure.ProcessModelFigure;
	...
	protected IFigure createFigure() {
		...
		LineBorder border= new LineBorder(1){
			...
			public void paint(IFigure figure, Graphics graphics, Insets insets) {
				...
				if(Activator.getDefault().getPreferenceStore().getBoolean(IACASTPreferences.CONTROLSTRUCTURE_PROCESS_MODEL_BORDER)){
