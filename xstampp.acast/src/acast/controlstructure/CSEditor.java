...
import acast.controlstructure.controller.factorys.CSModelCreationFactory;
import acast.controlstructure.controller.factorys.ConnectionCreationFactory;
...
public class CSEditor extends CSAbstractEditor {
	 ...
	 */
	public static final String ID = "acast.steps.step2_1"; //$NON-NLS-1$
