...
public class CausalFactorControllerTest {
  ...
  public void tearDown() throws Exception {
    ...
    data.addHazardId(UUID.randomUUID());
		Assert.assertNotNull(dataModel.changeCausalEntry(compId1, cf1Id, data));
    ...
    Assert.assertNull(dataModel.changeCausalEntry(hazId1, compId1, null));
    ...
    Assert.assertNull(dataModel.changeCausalEntry(compId1, factorId, new CausalFactorEntryData(entryId)));
