...
/**
 * A Class to define a common table view with a table and a description box
 * 
 * <ul>
 * <li>The Title of the Editor can be set by Overwriting {@link #getTitle()}
 * <li>The Title of the Table View shown in the Editor over the Table can be set by
 * {@link #setTableHeader(String)}
 * </ul>
 * 
 * @author Jarkko Heidenwag - initial API and implementation
 * @author Lukas Balzer
 * 
 * @since 1.0.0
 * 
...
public abstract class CommonTableView<T extends IDataModel> extends StandartEditorPart {
  ...
  public void createCommonTableView(Composite parent, String tableHeader) {
    ...
    this.itemsLabel.setText(this.tableHeader);
