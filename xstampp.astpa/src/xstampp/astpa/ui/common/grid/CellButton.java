...
public class CellButton implements ICellButton {
	 ...
	 * 
	 * @param rect
	 *            the bounds of the button, relative to the top left of the
	 *            cell.
	 * @param image
	...
	public void onPaint(GC gc, Rectangle cellBounds) {
		gc.drawImage(this.image, 0, 0, this.image.getBounds().width,
				this.image.getBounds().height, cellBounds.x
						+ this.getBounds().x,
				cellBounds.y + this.getBounds().y, this.getBounds().width,
