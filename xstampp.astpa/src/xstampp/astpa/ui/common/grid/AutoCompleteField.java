...
public class AutoCompleteField {
	...
	public AutoCompleteField(final Control control,
			...
			final String[] literals, final String[] labels,
			final String[] descriptions) {
		this.contentProposalProvider = new ContentProposalProvider(
				literals.clone(), labels, descriptions);
		this.contentProposalProvider.setFiltering(true);

		this.contentProposalAdapter = new LinkingCommandAdapter(control,
				controlContentAdapter, this.contentProposalProvider, null,
				null, false);
	...
	/**
	 * This function calculates a position by merging two Point and sets it as
	 * the popups Position
	 * 
	 * @author Lukas Balzer
	 * 
	 ...
	 *            mouse
	 */
	public void setPopupPosition(Point relativeMouse, Rectangle cellPosition,
			int topOffset) {
