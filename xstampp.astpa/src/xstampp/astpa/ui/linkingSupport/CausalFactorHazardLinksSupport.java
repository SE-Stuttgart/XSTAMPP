...
public class CausalFactorHazardLinksSupport extends LinkSupport<DataModelController> {
  ...
  public CausalFactorHazardLinksSupport(DataModelController dataInterface) {
    super(dataInterface, LinkingType.CausalHazLink_SC2_LINK, true);
  ...
  public String getText(UUID id) {
    String result;
    try {
      UUID ucaCfCompLink = getDataInterface().getLinkController()
          .getLinkObjectFor(LinkingType.CausalEntryLink_HAZ_LINK, id).getLinkA();
