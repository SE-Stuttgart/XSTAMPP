...
public abstract class LinkSupport<M extends ILinkModel> extends SelectionAdapter implements IContentProposalListener {
	...
	/**
	 * Sets the id of the entry which's links are displayed in the
	 * {@link TableViewer} set in {@link #setDisplayedList(TableViewer)}. This
	 * method updates the array obtained by {@link #getCurrentContent()} as well as
	 * the {@link List} returned by {@link #getAvailable()}.
	 * 
	 * @param id
	 ...
	 * 
	 * @param label
	 *            the literal returned by {@link #getDescription(UUID)} of the
	 *            abstract classes implementation.
	 * @return the index of the linked item with the given description, or
	 *         <b>null</b> if the label didn't match any current linked item
	 */
