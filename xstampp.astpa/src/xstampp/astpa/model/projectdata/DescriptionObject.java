...
public class DescriptionObject {
	...
	public boolean addRanges(StyleRange range,String description) {
		try{
			...
			if(range.background == null){
				...
				this.background = "#"+Integer.toHexString(red) + Integer.toHexString(green) + Integer.toHexString(blue);
			...
			if(range.foreground == null){
				...
				this.foreground = "#"+Integer.toHexString(red) + Integer.toHexString(green) + Integer.toHexString(blue);
	...
	public String toString() {
		...
		return foreground + " | "+background + " | " + style + " | "+ weight + " | " + fontSize + " | " + descriptionPart;
	}
