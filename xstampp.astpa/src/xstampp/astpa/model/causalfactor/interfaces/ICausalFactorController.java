...
public interface ICausalFactorController {
   ...
   * 
   * @param componentId
   *          the UUID of a control structure component stored in the data model
   * @param causalFactorId
   *          the UUID of a causal factor
   * @param entryData
   *          the change data for the causal entry one of {@link CausalFactorUCAEntryData} or
   *          {@link CausalFactorEntryData}
   * @return <b>true if</b>
   *         <ul>
   ...
   * if componentId is null than the method searches for the causal factor in all registered
   * components
   * 
   * @param componentId
   *          a UUID for which a component should be registered, or null if the id is not known or
   * @param causalFactorId
   *          the id of the causal factor which should be removed, when this is null or not valid
   *          the method
   *          returns false
   * @return
   */
