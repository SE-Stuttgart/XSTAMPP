...
public class SecControlActionController implements IControlActionController{
   ...
   * Searches for an Accident with given ID returns null if there is no one with this id
	...
	public String setUcaDescription(UUID unsafeControlActionId, String description) {
		UnsecureControlAction unsafeControlAction = this.getInternalUnsafeControlAction(unsafeControlActionId);
   ...
   * returns the current id number of the UnsafeControlAction with the given ucaID
	...
	public int getUCANumber(UUID ucaID) {
		for (ControlAction controlAction : this.controlActions) {
			for (UnsecureControlAction unsafeControlAction : controlAction.getInternalUnsafeControlActions()) {
   ...
   * @return the id of the corresponding safety constraint. null if the action fails
	...
	public String setCorrespondingSafetyConstraint(UUID unsafeControlActionId, String safetyConstraintDescription) {
		...
		if (unsafeControlAction.getCorrespondingSafetyConstraint().setTitle(safetyConstraintDescription) != null) {
			return oldTitle;
		}
		return null;
	}
	 ...
	 *         fails
	 */
	public UUID setUCASafetyCritical(UUID unsafeControlActionId, boolean safetyConstraintDescription) {
		UnsecureControlAction unsafeControlAction = this.getInternalUnsafeControlAction(unsafeControlActionId);
		if (unsafeControlAction == null) {
			return null;
		}
	 ...
	 *         fails
	 */
	public UUID setUCASecurityCritical(UUID unsafeControlActionId, boolean safetyConstraintDescription) {
		UnsecureControlAction unsafeControlAction = this.getInternalUnsafeControlAction(unsafeControlActionId);
		if (unsafeControlAction == null) {
			return null;
		}
	 ...
	 * 
	 */
	public void prepareForExport(VulLossController hazAccController, ControlStructureController csController,
