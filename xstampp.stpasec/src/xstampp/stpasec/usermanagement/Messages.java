package xstampp.stpasec.usermanagement;

import org.eclipse.osgi.util.NLS;

import xstampp.stpasec.usermanagement.Messages;

public class Messages extends NLS {
  private static final String BUNDLE_NAME = "xstampp.stpasec.usermanagement.messages"; //$NON-NLS-1$
