...
/**
 * this Handler changes the current Style of the text which is either written or selected in a text editor
 * this is done by calling {@link ITextEditor#setStyle(String)}
 * with the value of the parameter <code>xstampp.commandParameter.style</Code>
 *  
 * @author Lukas Balzer
 * 
 * @see ITextEditor
