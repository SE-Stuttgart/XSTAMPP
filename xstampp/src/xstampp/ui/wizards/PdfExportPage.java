...
public class PdfExportPage extends AbstractExportPage implements ModifyListener {
	...
	/**
	 * @param showCompanyFields the showCompanyFields to set
	 */
	...
	/**
	 * @param showDecorateCSButton the showDecorateCSButton to set
	 */
	...
	/**
	 * @param showFormatChooser the showFormatChooser to set
	 */
