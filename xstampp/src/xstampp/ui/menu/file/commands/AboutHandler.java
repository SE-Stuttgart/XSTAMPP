...
public class AboutHandler extends AbstractHandler {
	 ...
	 */
	private static final Image DIALOG_IMAGE = Activator.getImageDescriptor(
			"icons/Logo.png").createImage(); //$NON-NLS-1$
	/**
	 * The string displayed on the bar of the dialog.
	 */
	private static final String DIALOG_TITLE = Messages.About
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		AboutDialog dialog = new AboutDialog(parentShell,
				AboutHandler.DIALOG_TITLE, AboutHandler.DIALOG_IMAGE,
				dialogMessage, AboutHandler.NONE,
	...
	private String getDialogMessage() {
		...
		String visitLine = Messages.AboutKontakt
				+ ": " + "https://sourceforge.net/projects/astpa/"; //$NON-NLS-2$ 
		String contactPerson = "Contact Person : Asim Abdulkhaleq \n Email: Asim.Abdulkhaleq@informatik.uni-stuttgart.de";
		String versionLine = this.getVersionLine((String) dictionary
				.get(Messages.BundleVersion));
		String team = Messages.DevelopmentTeam
				+ "\t  " + "Aleksander Zotov, Aliaksei Babkovich, Benedikt Markt," //$NON-NLS-1$//$NON-NLS-2$ 
