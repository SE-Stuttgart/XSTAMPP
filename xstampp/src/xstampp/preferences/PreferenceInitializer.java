...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	 ...
	 */
	private static final Font DEFAUL_TITLE_FONT = new Font(
			Display.getCurrent(), Display.getCurrent().getSystemFont()
	...
	public void initializeDefaultPreferences() {
		...
		PreferenceConverter
				.setDefault(
						...
						Display.getCurrent()
								.getSystemColor(
										PreferenceInitializer.DEFAULT_NAVIGATION_ITEM_SELECTED)
								.getRGB());
		...
		PreferenceConverter
				.setDefault(
						...
						Display.getCurrent()
								.getSystemColor(
										PreferenceInitializer.DEFAULT_NAVIGATION_ITEM_UNSELECTED)
								.getRGB());
		...
		PreferenceConverter.setDefault(
				...
				Display.getCurrent()
						.getSystemColor(
								PreferenceInitializer.DEFAULT_HOVER_ITEM)
						.getRGB());
		...
		PreferenceConverter
				.setDefault(
						...
						Display.getCurrent()
								.getSystemColor(
										PreferenceInitializer.DEFAULT_SPLITTER_FOREGROUND)
								.getRGB());
		...
		PreferenceConverter
				.setDefault(
						...
						Display.getCurrent()
								.getSystemColor(
										PreferenceInitializer.DEFAULT_SPLITTER_BACKGROUND)
								.getRGB());
		...
		this.store.setDefault(IPreferenceConstants.PROJECT_NAME,
				Messages.NewProject);
		PreferenceConverter.setDefault(this.store,
				IPreferenceConstants.COMPANY_BACKGROUND_COLOR, Display
						.getCurrent().getSystemColor(SWT.COLOR_DARK_BLUE)
						.getRGB());

		PreferenceConverter.setDefault(this.store,
				IPreferenceConstants.COMPANY_FONT_COLOR, Display.getCurrent()
						.getSystemColor(SWT.COLOR_BLACK).getRGB());

		this.store.setDefault(
				IPreferenceConstants.SHOW_WELCOME_ON_STARTUP_PREFERENCES, true);
