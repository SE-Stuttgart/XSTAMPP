...
public abstract class AbstractWizardPage extends WizardPage {
	 ...
	 *
	 * @param pageName the page name
	 * @param title the title which is displayed in the banner
	 * @param titleImage the descriptor of the banner image in 64x64 
	 */
	...
	protected String openExportDialog(String[] filters) {
		return openExportDialog(filters, filters);
	}
	...
	protected final class PathComposite extends Composite{
		...
		public PathComposite(final String[] filter,final String[] names,Composite parent, int style){
			this(filter,names, parent, style, Messages.Destination);
		}
		
		
		public PathComposite(final String[] filter, final String[] filterNames,Composite parent,final int style,String name){
			this(parent, name);
			addButtonListener(new SelectionListener() {
				...
				public void widgetSelected(SelectionEvent e) {
					if(style == PathComposite.LOGO_DIALOG){
						...
						PathComposite.this.path.setText(AbstractWizardPage.this.openExportDialog(filter,filterNames));
					}
	...
	protected final class ColorChooser extends Composite{
		...
		public ColorChooser(Composite parent,int style,String text,final String constant) {
			...
			String companyBackgroundColor =
				PreferenceConverter.getColor(AbstractWizardPage.this.store, constant).toString();
			...
			AbstractWizardPage.this.setLabelIcon(this.colorIcon,
				PreferenceConverter.getColor(AbstractWizardPage.this.store, constant),
				1);
	...
	protected class DemoCanvas extends Canvas{
		...
		public DemoCanvas(Composite parent, int style) {
			...
			this.sampleTitle.setText( AbstractWizardPage.this.store.getString(IPreferenceConstants.PROJECT_NAME));
			...
			this.addPaintListener(new PaintListener() {
				...
				public void paintControl(PaintEvent e) {
					...
					this.fontColor= new Color(null,PreferenceConverter.getColor(AbstractWizardPage.this.store,
							IPreferenceConstants.COMPANY_FONT_COLOR));
					this.bgColor=new Color(null,PreferenceConverter.getColor(AbstractWizardPage.this.store,
