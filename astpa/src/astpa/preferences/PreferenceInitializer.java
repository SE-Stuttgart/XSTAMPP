...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	 ...
	 */
	private static final Font DEFAUL_TITLE_FONT = new Font(Display.getCurrent(), Display.getCurrent().getSystemFont()
		.getFontData().toString(), 11, SWT.BOLD);
	
	/**
	 * Default font used by labels of each view
	 */
	private static final Font DEFAUL_FONT = new Font(Display.getCurrent(), Display.getCurrent().getSystemFont()
		.getFontData().toString(), 9, SWT.BOLD);
	...
	public void initializeDefaultPreferences() {
		// Colors
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.NAVIGATION_ITEM_SELECTED, Display.getCurrent()
			.getSystemColor(PreferenceInitializer.DEFAULT_NAVIGATION_ITEM_SELECTED).getRGB());
		
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.NAVIGATION_ITEM_UNSELECTED, Display
			.getCurrent().getSystemColor(PreferenceInitializer.DEFAULT_NAVIGATION_ITEM_UNSELECTED).getRGB());
		
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.HOVER_ITEM, Display.getCurrent()
			.getSystemColor(PreferenceInitializer.DEFAULT_HOVER_ITEM).getRGB());
		
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.SPLITTER_FOREGROUND, Display.getCurrent()
			.getSystemColor(PreferenceInitializer.DEFAULT_SPLITTER_FOREGROUND).getRGB());
		
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.SPLITTER_BACKGROUND, Display.getCurrent()
			.getSystemColor(PreferenceInitializer.DEFAULT_SPLITTER_BACKGROUND).getRGB());
		
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.SPLITTER_FONT, Display.getCurrent()
			.getSystemColor(PreferenceInitializer.DEFAULT_SPLITTER_FONT).getRGB());
		...
		PreferenceConverter.setDefault(this.store, IPreferenceConstants.COMPANY_FONT_COLOR, Display.getCurrent()
