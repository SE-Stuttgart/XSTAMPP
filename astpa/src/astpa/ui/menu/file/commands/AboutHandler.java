...
public class AboutHandler extends AbstractHandler {
	 ...
	 */
	private static final String DIALOG_TITLE = Messages.About + Messages.ASTPA;
	/**
	...
	class AboutDialog extends MessageDialog {
		 ...
		 * 
		 * @param parentShell the shell containing the dialog.
		 * @param dialogTitle title displayed in bar of the dialog.
		 * @param dialogTitleImage image to display in the bar of the dialogue.
		 *            None is used.
		 * @param dialogMessage The message to be displayed in the dialogue
		 *            area. the version and build numbers plus the copyright
		 *            notice.
		 * @param dialogImageType no used.
		 * @param dialogButtonLabels only the OK button is displayed.
		 * @param defaultIndex only one button is used on this dialog so it must
		 *            be 0.
		 */
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		AboutDialog dialog =
			new AboutDialog(parentShell, AboutHandler.DIALOG_TITLE, AboutHandler.DIALOG_IMAGE, dialogMessage,
				AboutHandler.NONE, AboutHandler.DIALOG_BUTTONS_LABELS, AboutHandler.DEFAULT_INDEX);
	 ...
	 * 
	 * @param bundleVersion the version of the bundle in the format
	 *            v.m.n.qualifier
