...
public abstract class AbstractGridCell implements IGridCell {
	 ...
	 * @param renderer the renderer.
	 * @param gc the GC.
	 * @param item the nebula grid item the cell belongs to.
	 */
	public void paintFrame(GridCellRenderer renderer, GC gc, @SuppressWarnings("unused") NebulaGridRowWrapper item) {
