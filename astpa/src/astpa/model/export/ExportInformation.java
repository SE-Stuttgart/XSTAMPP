...
public class ExportInformation {
	...
	public ExportInformation() {
		...
		this.colorBackground =
			this.rgbToHex(PreferenceConverter.getColor(this.store, IPreferenceConstants.COMPANY_BACKGROUND_COLOR));
		this.colorFont =
			this.rgbToHex(PreferenceConverter.getColor(this.store, IPreferenceConstants.COMPANY_FONT_COLOR));
	}
	...
	/**
	 * @param csImagePath the csImagePath to set
	...
	/**
	 * @param cspmImagePath the cspmImagePath to set
	 * @return true, if the path has been set
	 */
	...
	/**
	 * @param colorFont the color to set
	 * @return true, if the color has been set
	 */
