...
public class HazAccController {
	...
	public UUID addAccident(String title, String description) {
		Accident newAccident = new Accident(title, description, this.accidents.size() + 1);
	 ...
	 * 
	 * @param title the title of the new hazard
	 * @param description the description of the new hazard
	 ...
	 * 
	 * @param id the id of the hazard or accident
	 * 
	 * @author Fabian Toth
	 */
