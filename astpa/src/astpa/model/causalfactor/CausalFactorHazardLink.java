...
public class CausalFactorHazardLink implements ICausalFactorHazardLink {
	 ...
	 * @author Fabian Toth
	 * 
	 * @param causalFactorId the id of the accident
	...
	/**
	 * @param causalFactorId the accidentId to set
	 */
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = (prime * result) + ((this.causalFactorId == null) ? 0 : this.causalFactorId.hashCode());
