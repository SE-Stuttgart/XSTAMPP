...
public class Anchor implements IAnchor {
	 ...
	 * 
	 * @param isFlying true if this anchor is flying, which means that it is
	 *            directly created on the root
	 * @param xOrientation the xOrientation of the new anchor
	 * @param yOrientation the yOrientation of the new anchor
	 * @param ownerId the id of the owner component
	 * 
	 * @author Fabian Toth
	 */
	...
	/**
	 * @param xOrientation the xOrientation to set
	 */
	...
	/**
	 * @param yOrientation the yOrientation to set
	 */
