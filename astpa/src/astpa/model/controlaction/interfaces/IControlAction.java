...
public interface IControlAction extends ITableModel {
	 ...
	 * 
	 * @param unsafeControlActionType the type of the unsafe control actions
	 * @return all unsafe control actions of the given type of this control
	 *         action
	 * 
	 * @author Fabian Toth
	 */
	List<IUnsafeControlAction> getUnsafeControlActions(UnsafeControlActionType unsafeControlActionType);
}
