...
public class UnsafeControlAction implements IUnsafeControlAction, ICorrespondingUnsafeControlAction {
	 ...
	 * @param type the type of the new unsafe control action
	 * 
	 * @author Fabian Toth
	 */
	...
	/**
	 * @param correspondingSafetyConstraint the correspondingSafetyConstraint to
	 *            set
	 */
