...
public class ControlAction extends ATableModel implements IControlAction {
	 ...
	 * 
	 * @param title the title of the new accident
	 * @param description the description of the new accident
	 * @param number the number of the new accident
	 * 
	 * @author Fabian Toth
	 */
	...
	@Override
	public List<IUnsafeControlAction> getUnsafeControlActions(UnsafeControlActionType unsafeControlActionType) {
		List<IUnsafeControlAction> result = new ArrayList<>();
		for (UnsafeControlAction unsafeControlAction : this.unsafeControlActions) {
	 ...
	 * @param unsafeControlActionType the type of the enw control action
	 * @return the id of the new control action
	 * 
	 * @author Fabian Toth
	 */
	public UUID addUnsafeControlAction(String description, UnsafeControlActionType unsafeControlActionType) {
		UnsafeControlAction unsafeControlAction = new UnsafeControlAction(description, unsafeControlActionType);
