...
public class UCAHazLink implements IUCAHazLink {
	 ...
	 * @author Fabian Toth
	 * 
	 * @param unsafeControlActionId the id of the accident
	...
	/**
	 * @param unsafeControlActionId the accidentId to set
	 */
	...
	public boolean containsId(UUID id) {
		return this.unsafeControlActionId.equals(id) || this.hazardId.equals(id);
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = (prime * result) + ((this.unsafeControlActionId == null) ? 0 : this.unsafeControlActionId.hashCode());
		result = (prime * result) + ((this.hazardId == null) ? 0 : this.hazardId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		} else if (!this.unsafeControlActionId.equals(other.unsafeControlActionId)) {
			return false;
		}
