...
public class SDSController {
	 ...
	 * 
	 * @param title the title of the new safety constraint
	 * @param description the description of the new safety constraint
	 * 
	...
	public UUID addSafetyConstraint(String title, String description) {
		SafetyConstraint safetyConstraint = new SafetyConstraint(title, description, this.safetyConstraints.size() + 1);
	 ...
	 * 
	 * @param safetyConstraintId the id of the safety constraint
	 ...
	 * 
	 * @param systemGoalId the id of the system goal
	 ...
	 * 
	 * @param title the title of the new design requirement
	 * @param description the title of the new design requirement
	 * 
	...
	public UUID addDesignRequirement(String title, String description) {
		DesignRequirement designRequirement =
			new DesignRequirement(title, description, this.designRequirements.size() + 1);
	 ...
	 * 
	 * @param designRequirementId ID of the design requirement
