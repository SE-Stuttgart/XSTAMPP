 ...
 * 
 */
public interface IHazardViewDataModel extends IDataModel {
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param hazardId The ID of the hazards which has to be deleted
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param hazardId The hazard's id
	 * 
	 * @param title The hazards's new title
	 ...
	 * @param hazardId The hazard's id
	 * 
	 * @param description The hazards's new description
