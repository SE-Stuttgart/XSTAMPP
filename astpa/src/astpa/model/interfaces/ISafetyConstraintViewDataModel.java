 ...
 * 
 */
public interface ISafetyConstraintViewDataModel extends IDataModel {
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param safetyConstraintId The ID of the safety constraint which has to be
	 *            deleted
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param safetyConstraintId The safety constraint's id
	 * 
	 * @param title The safety constraint's new title
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param safetyConstraintId The safety constraints's id
	 * 
	 * @param description The safety constraint's new description
