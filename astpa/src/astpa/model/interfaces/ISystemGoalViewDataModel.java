...
public interface ISystemGoalViewDataModel extends IDataModel {
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param systemGoalId The ID of the system goal which has to be deleted
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param systemGoalId The system goal's id
	 * 
	 * @param title The system goal's new title
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param systemGoalId The system goals's id
	 * 
	 * @param description The system goal's new description
