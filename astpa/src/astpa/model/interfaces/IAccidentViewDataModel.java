 ...
 * 
 */
public interface IAccidentViewDataModel extends IDataModel {
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param accidentId The ID of the accident which has to be deleted
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param accidentId The accident's id
	 * 
	 * @param title The accident's new title
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param accidentId The accidents's id
	 * 
	 * @param description The accident's new description
	 ...
	 * @param accidentId the ID of the accident.
	 * 
	 * @return the accident.
	 */
