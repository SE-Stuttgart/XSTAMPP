...
public interface IDesignRequirementViewDataModel extends IDataModel {
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param description The description of the new design requirement
	 ...
	 * @author Jarkko Heidenwag
	 * 
	 * @param designRequirementId The ID of the design requirement which has to
	 *            be deleted
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param designRequirementId The design requirement's id
	 * 
	 * @param title The design requirement's new title
	 ...
	 * 
	 * @author Jarkko Heidenwag
	 * @param designRequirementId The design requirements's id
	 * 
	 * @param description The design requirement's new description
	 * @return true if the description has been set
	 */
	boolean setDesignRequirementDescription(UUID designRequirementId, String description);
	
	/**
	 * Get an design requirement by it's ID.
	 * 
	 * @author Jarkko Heidenwag, Patrick Wickenhaeuser
	 * @param designRequirementId the ID of the design requirement.
	 * 
