...
public class ComponentCreateCommand extends ControlStructureAbstractCommand {
	 ...
	 * @author Lukas Balzer, Aliaksei Babkovich
	 * 
	 * @param csModel The Model of the Component which shall be set
	 */
	 ...
	 * @author Lukas Balzer, Aliaksei Babkovich
	 * 
	 * @param csModel The Model of the Root, which shall be set as the parent of
	 *            the Component
	 */
	public void setRootModel(IRectangleComponent csModel) {
		this.rootModel = csModel;
		this.rootLayout = csModel.getLayout(this.getStepID().equals(CSEditor.ID)).getCopy();
	 ...
	 * @author Lukas Balzer
	 * 
	 * @param model the layout constraint
	 */
	 ...
	 * @author Lukas Balzer, Aliaksei Babkovich
	 * 
	 * @param rect the rectangle which stores the new Layout
	 */
	public void setLayout(Rectangle rect) {
		...
		if (this.rootModel.getComponentType() == ComponentType.PROCESS_VARIABLE) {
			...
			this.rootLayout
				.setWidth(Math.max(this.oldRootLayout.width, rect.width + CSEditPolicy.PROCESS_MODEL_COLUMN));
	...
	public boolean canUndo() {
		...
		return this.getDataModel().getComponent(this.rootModel.getId()).getChildren().contains(this.compModel);
