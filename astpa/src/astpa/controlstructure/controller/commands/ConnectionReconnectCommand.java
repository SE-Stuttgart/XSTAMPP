...
public class ConnectionReconnectCommand extends ControlStructureAbstractCommand {
	 ...
	 * @author Lukas Balzer, Aliaksei Babkovich
	 * 
	 * @param target The old TargetAnchor
	 * @param source the new Source the connection should be get
	 * 
	 */
	 ...
	 * 
	 * @author Lukas Balzer, Aliaksei Babkovich
	 * @param target the target Anchor of this Connection
	 * @param source The old SourceAnchor
	 */
	...
	public void execute() {
		if (this.newSourceAnchorModel != null) {
			this.getDataModel().changeConnectionSource(this.connId, this.newSourceAnchorModel);
		} else if (this.newTargetAnchorModel != null) {
			this.getDataModel().changeConnectionTarget(this.connId, this.newTargetAnchorModel);
		} else {
	...
	@Override
	public void undo() {
		this.getDataModel().changeConnectionSource(this.connId, this.oldSourceAnchorModel);
		this.getDataModel().changeConnectionTarget(this.connId, this.oldTargetAnchorModel);
	}
