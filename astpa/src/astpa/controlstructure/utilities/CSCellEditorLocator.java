...
public class CSCellEditorLocator implements CellEditorLocator {
	 ...
	 * @author Lukas Balzer
	 * 
	 * @param label The label is set as the nameLabel
	 */
	...
	public void relocate(CellEditor celleditor) {
		...
		rect.setWidth(this.nameLabel.getParent().getBounds().width);
		...
		// overwritten by text
		editorHeight = Math.max(rect.height, text.getLineHeight() * text.getLineCount());
		text.setBounds(rect.x + X_OFFSET, rect.y + Y_OFFSET, rect.width + WIDTH_OFFSET, editorHeight + HEIGHT_OFFSET);
