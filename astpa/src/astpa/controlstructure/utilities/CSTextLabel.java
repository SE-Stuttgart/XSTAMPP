...
public class CSTextLabel extends FlowPage {
	 ...
	 * 
	 * @author Lukas Balzer
	 * @param csFigure the parent figure
	 * 
	 */
	 ...
	 * @author Lukas Balzer
	 * 
	 * @param style a SWT int constant
	 * @see SWT#NORMAL
	 * @see SWT#BOLD
	 * @see SWT#ITALIC
	 */
	public void setFontStyle(int style) {
		this.content.setFont(new Font(null, "Arial", INITIAL_TEXT_SIZE, style)); //$NON-NLS-1$
	}
	 ...
	 * @author Lukas Balzer
	 * 
	 * @param newColor Color of the text
	 */
	...
	public Rectangle getTextBounds() {
		Rectangle rect = getParent().getBounds().getCopy();
		...
		rect.setLocation(CENTER_COMPENSATION, CENTER_COMPENSATION);
