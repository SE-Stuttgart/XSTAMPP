...
;General
	...
	;Name and file
	Name "XSTAMPP"
	OutFile "XSTAMPP_Setup_32bit.exe"
	Icon "logo.ico"
...
Section "A-STPA" SecDummy
	...
	!system 'java -jar astpa.listfiles.jar "./../astpa.repository/target/products/xstampp_product/win32/win32/x86" "list.txt" "unlist.txt"'
	!include list.txt
	!system 'del list.txt'
